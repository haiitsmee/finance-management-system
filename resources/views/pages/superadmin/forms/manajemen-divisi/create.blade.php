...
@section('content')
    <div class="flex flex-col">
        <h1 class="text-3xl text-black">Tambah Divisi</h1>
        ...
        <form action="{{ route('superadmin.manajemen-divisi.store') }}" method="POST" class="mt-10">
            @csrf
            <div class="flex gap-10">
                <div class="flex flex-col gap-5">
                    ...
                    <x-form.input for="kontak" type="text" label="Kontak"
                        placeholder="Kontak" :readonly="false" :required="true" value="" width="w-70" />
                    <x-form.input for="jumlah_karyawan" type="number" label="Jumlah Karyawan"
                        placeholder="Jumlah karyawan" :readonly="false" :required="true" value="" width="w-70" />
